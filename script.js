...
text.forEach((text) => {
  text.addEventListener("mousemove", function () {
    cursor.classList.add("anchor-cursor");
  });
  text.addEventListener("mouseleave", function () {
    cursor.classList.remove("anchor-cursor");
  });
});

function specifyCursor(_idLink) {
  document.getElementById(_idLink).addEventListener("mousemove", function () {
    cursor.classList.add(_idLink);
  });
  document.getElementById(_idLink).addEventListener("mouseleave", function () {
    cursor.classList.remove(_idLink);
  });
}

specifyCursor("mollowLink");
specifyCursor("hourrailLink");
specifyCursor("documentLink");
specifyCursor("elecCar1Link");
specifyCursor("elecCar2Link");
specifyCursor("plane1Link");
specifyCursor("plane2Link");
